...
![[3-4-Pointer-Arithmetic_img_1.jpeg]]
...
![[3-4-Pointer-Arithmetic_img_2.jpeg]]
...
![[3-4-Pointer-Arithmetic_img_3.jpeg]]
...
![[3-4-Pointer-Arithmetic_img_4.jpeg]]
...
![[3-4-Pointer-Arithmetic_img_5.jpeg]]
...
![[3-4-Pointer-Arithmetic_img_6.jpeg]]

In this example, text points to the first item in the string (' $s$ '). The loop starts by assigning $p$ to also point to the first item. The loop continues by advancing p through the string. The loop terminates when $* \mathrm{p}$ is no longer true. This occurs when $p$ points to the null-character.
