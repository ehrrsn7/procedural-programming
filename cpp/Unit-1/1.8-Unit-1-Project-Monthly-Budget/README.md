...
The purpose of getIncome() is to prompt the user for their income and return the value to main():
...
The purpose of computeTithing() is to determine the amount that is required to be a full tithe payer. This does not include fast offerings and other offerings.
...
A few hints:
- A tab is used for most of the indentations and nowhere else.
